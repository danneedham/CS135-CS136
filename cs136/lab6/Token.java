...
public class Token
{
     ...
     */
    private SinglyLinkedList<Token> procedure;	// a list of tokens for procedures
     ...
     */
    public Token(SinglyLinkedList<Token> proc)
    {
	kind = ProcedureKind;
	this.procedure = proc;
    }
     ...
     */
    public SinglyLinkedList<Token> getProcedure()
    {
