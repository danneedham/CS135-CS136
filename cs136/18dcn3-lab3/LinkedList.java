...
public class LinkedList<E> extends DoublyLinkedList<E>
{
	...
	DoublyLinkedNode<E> nextFinger = previous.next();
	DoublyLinkedNode<E> insertion = new DoublyLinkedNode<E>(value,nextFinger,previous);
	previous.setNext(insertion);
	nextFinger.setPrevious(insertion);
	count++;
    }
    ...
    {
	// Students: write this code
	DoublyLinkedNode<E> previous = node.previous();
    ...
    {
	// Students: modify this code.
	DoublyLinkedNode<E> last = tail.previous();
	return last.value();
    }
